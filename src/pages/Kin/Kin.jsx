...
const Kin = ({ kin }) => {
    const {id, picture, name, tags, status, days_since_contact } = kin;
    ...
    return (
        <Link to={`/kinDetails/${id}`} className="w-full max-w-xs h-full">
            <div className="card bg-base-200 w-full flex flex-col h-full max-w-xs shadow-sm p-1">
