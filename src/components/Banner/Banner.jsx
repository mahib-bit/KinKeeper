...
const Banner = () => {
    return (
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 my-4">
            <div className="bg-base-200 rounded-2xl p-6 sm:p-10 lg:p-16 text-center">
                ...
                <div className="w-full mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
